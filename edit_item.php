...
<body>
    ...
    <div class="heroInventory">
        <div class="container-fluid p-5">
            <div class="inventoryBox text-align-center">
            <h2 class="mb-3"> Edit Items </h2>
                <form method="post" action="update_item.php">
                    <div class="mb-3">
                        <label for="item_name" class="form-label">Item Name:</label>
                        <input type="text" name="item_name" class="form-control" value="<?php echo $itemData['item_name']; ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="quantity" class="form-label">Quantity:</label>
                        <input type="number" name="quantity" class="form-control" value="<?php echo $itemData['quantity']; ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="item_desc" class="form-label">Item Description:</label>
                        <textarea name="item_desc" class="form-control"><?php echo $itemData['item_desc']; ?></textarea>
                    </div>
